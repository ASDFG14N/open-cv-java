...
public class TableCustom extends JTable {
    ...
    private TableCustomHeader header;
    private TableCustomCell cell;

    public TableCustom() {
        header = new TableCustomHeader();
        cell = new TableCustomCell();
    ...
    private class TableCustomHeader extends DefaultTableCellRenderer {
    ...
    private class TableCustomCell extends DefaultTableCellRenderer {
